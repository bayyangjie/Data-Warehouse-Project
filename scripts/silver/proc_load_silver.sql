...
-- If there are changes done in the stored procedure, rerun the stored procedure 
query segment first before executing the EXEC statement
==================================================================================
*/
...
BEGIN
	...
	BEGIN TRY
		...
		TRUNCATE TABLE silver.crm_cust_info;   -- to ensure that the table is not inserted twice each time the query is ran 
